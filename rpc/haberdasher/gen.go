...
//go:generate retool do protoc --proto_path=$GOPATH/src --twirp_out=$GOPATH/src --go_out=$GOPATH/src github.com/hashtagchris/twirp-example/rpc/haberdasher/haberdasher.proto
